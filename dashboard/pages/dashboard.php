...
// Mulai session
session_start();
require_once '../../proses/proses.php'; // Pastikan jalur ke file koneksi benar
...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand px-4 py-3 m-0" href="#" target="_blank">
        <img src="../../image/about-icon-2.png" class="navbar-brand-img" width="26" height="26" alt="main_logo">
        <span class="ms-1 text-sm text-dark">Coffe Shop</span>
      </a>
    </div>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-2">
      <div class="row">
        <div class="ms-3">
          <h3 class="mb-0 h4 font-weight-bolder">Welcome <?php echo htmlspecialchars($_SESSION['username']); ?></h3>
          <p class="mb-4">
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="https://rifkiimaulana.my.id" class="font-weight-bold" target="_blank">Rifki Maulana</a>
                for a better web.
              </div>
            </div>
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                <a href="https://github.com/rifkimaulanaa" class="nav-link text-muted" target="_blank"><i class="fa fa-github" style="font-size:24px"></i> Github</a>
                </li>
                <li class="nav-item">
  ...
  <div class="fixed-plugin">
    ...
    <div class="card shadow-lg">
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <p class="text-sm d-xl-none d-block mt-2">You can change the side nav type just on desktop view.</p>
        <!-- Navbar Fixed -->
